...
{
    public class RiptideRavagerRelicI : ModItem
    {
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<RiptideRavagerRelic>(), 0);
    ...
    public class RiptideRavagerRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "TenebrousMod/Items/Placeable/Furniture/RiptideRavagerRelic";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "TenebrousMod/Items/Placeable/Furniture/RiptideRavagerRelicPed";
