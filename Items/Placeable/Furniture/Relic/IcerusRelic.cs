...
{
    public class IcerusRelicI : ModItem
    {
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<IcerusRelic>(), 0);
    ...
    public class IcerusRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "TenebrousMod/Items/Placeable/Furniture/Relic/IcerusRelic";
