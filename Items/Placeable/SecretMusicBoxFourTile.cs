...
{
    public class SecretMusicBoxFour : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SecretMusicFour"), ModContent.ItemType<SecretMusicBoxFour>(), ModContent.TileType<SecretMusicBoxFourTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<SecretMusicBoxFourTile>(), 0);
        }
    }
    public class SecretMusicBoxFourTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SecretMusicBoxFour>();
        }
    }
}
