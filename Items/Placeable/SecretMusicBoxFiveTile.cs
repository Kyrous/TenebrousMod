...
{
    public class SecretMusicBoxFive : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SecretMusicFive"), ModContent.ItemType<SecretMusicBoxFive>(), ModContent.TileType<SecretMusicBoxFiveTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<SecretMusicBoxFiveTile>(), 0);
        }
    }
    public class SecretMusicBoxFiveTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SecretMusicBoxFive>();
        }
    }
}
