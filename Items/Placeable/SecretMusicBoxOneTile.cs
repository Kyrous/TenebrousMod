...
{
    public class SecretMusicBoxOne : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SecretMusicOne"), ModContent.ItemType<SecretMusicBoxOne>(), ModContent.TileType<SecretMusicBoxOneTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<SecretMusicBoxOneTile>(), 0);
        }
    }
    public class SecretMusicBoxOneTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SecretMusicBoxOne>();
        }
    }
}
