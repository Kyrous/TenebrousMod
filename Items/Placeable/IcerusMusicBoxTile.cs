...
{
    public class IcerusMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/IcerusTheme"), ModContent.ItemType<IcerusMusicBox>(), ModContent.TileType<IcerusMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<IcerusMusicBoxTile>(), 0);
        }
    }
    public class IcerusMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<IcerusMusicBox>();
        }
    }
}
