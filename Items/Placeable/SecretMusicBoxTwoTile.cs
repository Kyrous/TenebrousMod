...
{
    public class SecretMusicBoxTwo : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SecretMusicTwo"), ModContent.ItemType<SecretMusicBoxTwo>(), ModContent.TileType<SecretMusicBoxTwoTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<SecretMusicBoxTwoTile>(), 0);
        }
    }
    public class SecretMusicBoxTwoTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SecretMusicBoxTwo>();
        }
    }
}
