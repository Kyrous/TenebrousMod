...
{
    public class MainMenuThemeNightMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/MainMenuMusic2"), ModContent.ItemType<MainMenuThemeNightMusicBox>(), ModContent.TileType<MainMenuThemeNightMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<MainMenuThemeNightMusicBoxTile>(), 0);
        }
    }
    public class MainMenuThemeNightMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<MainMenuThemeNightMusicBox>();
        }
    }
}