...
{
    public class SecretMusicBoxThree : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SecretMusicThree"), ModContent.ItemType<SecretMusicBoxThree>(), ModContent.TileType<SecretMusicBoxThreeTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<SecretMusicBoxThreeTile>(), 0);
        }
    }
    public class SecretMusicBoxThreeTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SecretMusicBoxThree>();
        }
    }
}
