...
{
    public class MainMenuThemeDayMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/MainMenuMusic"), ModContent.ItemType<MainMenuThemeDayMusicBox>(), ModContent.TileType<MainMenuThemeDayMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<MainMenuThemeDayMusicBoxTile>(), 0);
        }
    }

    public class MainMenuThemeDayMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<MainMenuThemeDayMusicBox>();
        }
    }
}