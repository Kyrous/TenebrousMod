...
namespace TenebrousMod.Items.Weapons.TheGreatHarpy
{
    ...
    public class WingedJavelinProj : ModProjectile
    {
        ...
        {
            winglessTexture = Mod.Assets.Request<Texture2D>("Items/Weapons/TheGreatHarpy/WingedJavelinProj");
            wingTexture = Mod.Assets.Request<Texture2D>("Items/Weapons/TheGreatHarpy/WingedJavelinProj2");
